      ...
      <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
        {first && (
          <div className="relative lg:col-span-5">
            ...
            {second && (
              <div className="absolute -bottom-8 right-0 aspect-square w-[48%] overflow-hidden rounded-full border-[6px] border-paper">
          ...
          {section.highlights && section.highlights.length > 0 && (
            <dl className="mt-10 grid gap-6 sm:grid-cols-2">
              {section.highlights.map((item) => (
                <div key={item.title} className="rounded-card bg-linen p-6">
                  <dt className="font-display text-subtitle font-semibold">{item.title}</dt>
