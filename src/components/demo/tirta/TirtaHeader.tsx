...
/**
 * DEMO D · TIRTA — header.
 * A thin linen bar with the opening hours, address and phone (from the live footer data),
 * then a white bar with the logo, the live menu and a round booking button. Only the white bar stays at the top.
 */
export default function TirtaHeader() {
  return (
    <>
